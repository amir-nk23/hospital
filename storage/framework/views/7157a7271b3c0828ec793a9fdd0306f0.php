<?php $__env->startSection('content'); ?>
    ...
    <div class="card-body mt-5" style="box-shadow:0 4px 20px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)">
        ...
        <form method="post" action="<?php echo e(route('superadmin.store')); ?>">
                ...
                <div style="display: flex;flex-wrap: wrap;">
                    ...
                    <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div  style="flex-basis: 16.66%">
                            ...
                            <input type="checkbox" name="permissions[]" value="<?php echo e($permission->name); ?>" class="box-content">
                        </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\hospital\resources\views/user/superadmin/create.blade.php ENDPATH**/ ?>