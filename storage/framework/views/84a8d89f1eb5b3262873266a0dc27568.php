                        ...
                        <div class="card-body">
                            ...
                            <div class="col-12">
                                ...
                                <table class="table card-table table-vcenter text-nowrap table-primary mb-0">
                                    ...
                                    <?php $__currentLoopData = $invoice->surgery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surgery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\hospital\resources\views/invoice/show.blade.php ENDPATH**/ ?>