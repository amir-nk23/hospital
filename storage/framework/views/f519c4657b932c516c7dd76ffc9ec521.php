                        ...
                        <div class="table-responsive">
                            <table class="table table-striped card-table table-vcenter text-nowrap mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="text-success"><?php if($doctorsurgery->invoice): ?> <?php if($doctorsurgery->invoice->status ==1): ?> <?php endif; ?><span class="text-primary">تسویه شده</span> <?php else: ?> <span class="text-azure">تسویه نشده</span> <?php endif; ?></td>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\hospital\resources\views/report/invoice/index.blade.php ENDPATH**/ ?>