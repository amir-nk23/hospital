          ...
          <div class="card shadow overflow-hidden  bg-transparent position-relative" >
              <a href="<?php echo e(route('setting.general')); ?>" style="cursor: pointer">
                  ...
                  <div class="card-body bg bg-success" style="height:300px;text-align: center">
                      ...
                      <h1 class="text-white"><i><img height="40px" src="<?php echo e(asset('svg/exclamation.ico')); ?>"></i></h1>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\hospital\resources\views/setting/index.blade.php ENDPATH**/ ?>