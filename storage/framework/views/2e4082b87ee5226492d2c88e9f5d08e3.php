        ...
        <div class="col-xl-3 col-lg-6 mt-3 col-md-12">
            <div class="card" style=" box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);height:230px;">
                <div class="card-body">
                    ...
                    <h2 class="mb-1 font-weight-bold"><?php echo e($doctors); ?></h2>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 mt-3 col-md-12" >
            <div class="card" style=" box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);height: 230px">
                <div class="card-body">
                    ...
                    <h2 class="mb-1 font-weight-bold"><?php echo e(number_format($invoice)); ?></h2>
        ...
        <div class="col-xl-3 col-lg-6 mt-3 col-md-12">
            <div class="card" style=" box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);height: 230px">
                <div class="card-body">
                    ...
                    <h2 class="mb-1 font-weight-bold"><?php echo e(number_format($payment)); ?></h2>
                    <span class="mb-1 text-muted"><span class="text-success"></span> از ماه گذشته</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 mt-3 col-md-12">
            <div class="card" style=" box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);height: 230px">
                <div class="card-body">
                    ...
                    <h2 class="mb-1 font-weight-bold"><?php echo e($surgery); ?></h2>
                    <span class="mb-1 text-muted"><span class="text-success"></span> از ماه گذشته</span>
                </div>
            </div>
        </div>
            ...
            <div class="inbox-body">
                ...
                <div class="table-responsive">
                    <table class="table table-inbox table-hover text-nowrap mb-0">
                        ...
                        <?php $__currentLoopData = $paymentsDash; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pdash): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <tr class="">
                                <td class="view-message"><?php echo e($pdash->invoices->doctors->name); ?></td>
                                <td class="view-message"><?php $__currentLoopData = $pdash->invoices->surgeries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surgery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td class="view-message text-right font-weight-semibold">
                                    <?php echo e(number_format($pdash->amount)); ?>

                                </td>
                                <td class="view-message text-right font-weight-semibold">
                                    <?php echo e(__('custom.'.$pdash->pay_type)); ?>

                                </td>
                                <td class="view-message text-right font-weight-semibold">
                                    <?php echo e($pdash->jalaliDate()); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\hospital\resources\views/dashboard/index.blade.php ENDPATH**/ ?>