...
@section('content')
    ...
    <div class="card-body mt-2" style="box-shadow:0 4px 20px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)">
            ...
            <div class="row">
                ...
                <div class="col-6 form-group">
                    ...
                    <select class="form-control"  name="basic_insurance_id">
                        <option class="placeholder" value="null" >لطفا بیمه پایه را انتخاب کنید</option>
                ...
                <div class="col-6 form-group">
                    ...
                    <select class="form-control"  name="supp_insurance_id">
                        <option class="placeholder" value="null" >لطفا بیمه تکمیلی را انتخاب کنید</option>
                    ...
                    <div class="col-4 form-group">
                        ...
                        <select class="form-control" name="doctor_id[]">
                            ...
                            @foreach($role->doctor as $DR)
                                ...
                                <option value="{{$operation->id}}">{{$DR->name}}</option>
